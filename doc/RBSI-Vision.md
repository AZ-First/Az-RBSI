...
As described in the [Getting Started Guide](RBSI-GSG.md), we include a 3D print
...
to the Vivid Hosting radio (port 2 or 3) via ethernet, or connect to a network
switch connected to the radio via ethernet, and connect to the PhotonVision
software at the address ``http://photonvision.local:5800``.
...
where "TE.AM" is the appropriate parsing of your team number into IP address,
...
The static address allows for more stable operation, and these particular
